...
*/
export class IoMetallbV1beta1BGPPeerList {
    /**
    ...
    */
    'items': Array<IoMetallbV1beta1BGPPeer>;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "items",
            "baseName": "items",
            "type": "Array<IoMetallbV1beta1BGPPeer>"
        },
        {
            "name": "kind",
            "baseName": "kind",
    ...
    static getAttributeTypeMap() {
        return IoMetallbV1beta1BGPPeerList.attributeTypeMap;
    }
}
