...
export class IoCertManagerV1ClusterIssuerSpecVaultAuthKubernetes {
    ...
    */
    ...
    'serviceAccountRef'?: IoCertManagerV1ClusterIssuerSpecVaultAuthKubernetesServiceAccountRef;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "IoCertManagerV1ClusterIssuerSpecVaultAuthKubernetesServiceAccountRef"
        }    ];
