...
*/
export class IoMetallbV1beta1BGPAdvertisementList {
    /**
    ...
    */
    'items': Array<IoMetallbV1beta1BGPAdvertisement>;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "items",
            "baseName": "items",
            "type": "Array<IoMetallbV1beta1BGPAdvertisement>"
        },
        {
            "name": "kind",
            "baseName": "kind",
    ...
    static getAttributeTypeMap() {
        return IoMetallbV1beta1BGPAdvertisementList.attributeTypeMap;
    }
}
