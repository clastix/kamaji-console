...
*/
export class IoMetallbV1beta2BGPPeerList {
    /**
    ...
    */
    'items': Array<IoMetallbV1beta2BGPPeer>;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "items",
            "baseName": "items",
            "type": "Array<IoMetallbV1beta2BGPPeer>"
        },
        {
            "name": "kind",
            "baseName": "kind",
    ...
    static getAttributeTypeMap() {
        return IoMetallbV1beta2BGPPeerList.attributeTypeMap;
    }
}
