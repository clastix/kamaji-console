...
*/
export class IoMetallbV1beta1IPAddressPool {
    /**
    ...
    */
    ...
    'spec': IoMetallbV1beta1IPAddressPoolSpec;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "spec",
            "baseName": "spec",
            "type": "IoMetallbV1beta1IPAddressPoolSpec"
        },
        {
            "name": "status",
            "baseName": "status",
    ...
    static getAttributeTypeMap() {
        return IoMetallbV1beta1IPAddressPool.attributeTypeMap;
    }
}
