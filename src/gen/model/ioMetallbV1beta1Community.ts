...
*/
export class IoMetallbV1beta1Community {
    /**
    ...
    */
    ...
    'spec'?: IoMetallbV1beta1CommunitySpec;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "spec",
            "baseName": "spec",
            "type": "IoMetallbV1beta1CommunitySpec"
        },
        {
            "name": "status",
            "baseName": "status",
    ...
    static getAttributeTypeMap() {
        return IoMetallbV1beta1Community.attributeTypeMap;
    }
}
