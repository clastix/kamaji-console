...
*/
export class IoMetallbV1beta1IPAddressPoolList {
    /**
    ...
    */
    'items': Array<IoMetallbV1beta1IPAddressPool>;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "items",
            "baseName": "items",
            "type": "Array<IoMetallbV1beta1IPAddressPool>"
        },
        {
            "name": "kind",
            "baseName": "kind",
    ...
    static getAttributeTypeMap() {
        return IoMetallbV1beta1IPAddressPoolList.attributeTypeMap;
    }
}
