...
/**
* L2AdvertisementList is a list of L2Advertisement
*/
export class IoMetallbV1beta1L2AdvertisementList {
    /**
    ...
    */
    'items': Array<IoMetallbV1beta1L2Advertisement>;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "items",
            "baseName": "items",
            "type": "Array<IoMetallbV1beta1L2Advertisement>"
        },
        {
            "name": "kind",
            "baseName": "kind",
    ...
    static getAttributeTypeMap() {
        return IoMetallbV1beta1L2AdvertisementList.attributeTypeMap;
    }
}
