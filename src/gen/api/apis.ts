...
export * from './metallbIoV1beta1Api';
import { MetallbIoV1beta1Api } from './metallbIoV1beta1Api';
export * from './metallbIoV1beta2Api';
import { MetallbIoV1beta2Api } from './metallbIoV1beta2Api';
...
export const APIS = [AcmeCertManagerIoV1Api, AdmissionregistrationApi, AdmissionregistrationV1Api, ApiextensionsApi, ApiextensionsV1Api, ApiregistrationApi, ApiregistrationV1Api, ApisApi, AppsApi, AppsV1Api, AuthenticationApi, AuthenticationV1Api, AuthorizationApi, AuthorizationV1Api, AutoscalingApi, AutoscalingV1Api, AutoscalingV2Api, BatchApi, BatchV1Api, CertManagerIoV1Api, CertificatesApi, CertificatesV1Api, CoordinationApi, CoordinationV1Api, CoreApi, CoreV1Api, DiscoveryApi, DiscoveryV1Api, EventsApi, EventsV1Api, FlowcontrolApiserverApi, FlowcontrolApiserverV1Api, FlowcontrolApiserverV1beta3Api, KamajiClastixIoV1alpha1Api, LogsApi, MetallbIoV1beta1Api, MetallbIoV1beta2Api, NetworkingApi, NetworkingV1Api, NodeApi, NodeV1Api, OpenidApi, PolicyApi, PolicyV1Api, RbacAuthorizationApi, RbacAuthorizationV1Api, SchedulingApi, SchedulingV1Api, StorageApi, StorageV1Api, VersionApi, WellKnownApi];
